...
Definition FlatTPRLang (C : FlatTPR) := FlatTPR_wellformed C /\ exists (sf : list nat), list_ofFlatType sf (Sigma C) /\ relpower (validFlat (Sigma C) (rewritesHeadList (windows C))) (steps C) (init C) sf /\ satFinal (final C) sf. 
