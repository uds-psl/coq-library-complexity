...
Section fixTM. 
  ...
  (*identity rules *)
  (*the definition here is simplified: the first constructor creates spurious windows which don't do any harm,
    but simplify the definition as we need less cases
  *)
  ...
  (*in fact, all tape rules are invariant under polarity flip + reversion: for the shift rules, this directly
  ...
  (*the following lemmas allow us to prove results only for the right tape half and derive the corresponding
    results for the left tape half as corollaries *)
  (*Lemma 15 *)
  ...
  *)
  ...
  Proof.  
    ...
    - constructor 3. 
      + destruct_tape_in H1.   
        * specialize (string_reprTape'_length H1) as H1'. 
  ...
  Ltac list_length_inv := repeat match goal with 
      | [H : S _ = |?a| |- _] => is_var a; destruct a; cbn in H; [ congruence | apply Nat.succ_inj in H]
