...
\begin{frame}{Generic NP-hard Problem}
  ...
  \only<2->{\frametitle{Generic NP-hard Problem on Turing Machines}}
...
\begin{frame}<1>[label=tableau]{Tableau\footnote{based on\cite{Sipser:TheoryofComputation}}}
  \begin{center}
    \begin{tikzpicture}[scale=0.8, every node/.style={scale=0.8}]
      ...
      \path[<->] (1.5, -4.5) edge node[fill=white, anchor=center, pos=0.5] {\small \only<1>{ $l$}\only<2>{ $2z + 1$}} (10, -4.5);
...
\begin{frame}[t]{Tape Shifts}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \only<5-> {
        \draw[color=\colorTikzA] (5.25, 0) -- (7.5, 0);
...
\end{center}
  ...
  %\TODO{the annotation $z$ isn't consistent with the usage of $z$ in the other graphics (off-by-three)}
\end{frame}
...
\begin{frame}{Reduction to Binary Alphabet}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[dotted, thick, color=\colorTikzD] (1,-1) -- (1, 1) -- (4, 1) -- (4, -1) -- (1, -1);
      ...
      \draw[dotted, thick, color=\colorTikzD] (0, -3.5) -- (0, -1.5) -- (6, -1.5) -- (6, -3.5) -- (0, -3.5);
