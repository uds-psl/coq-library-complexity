...
\setCoqFilename{Undecidability.L.Complexity.Cook.FSAT_to_SAT}
...
\begin{theorem}[Correctness of $\tseytin'$][tseytin'_repr]
...
\begin{proposition}
  ...
  \begin{enumerate}
    ...
    \coqitem[tseytin'_size] If $\tseytin'~nf~f = (v, N, nf')$, then $\textsf{size}_{\cnf}~N \le c_{\textsf{tseytin}} \cdot \textsf{size}_{\formula}~f$
  \end{enumerate}
