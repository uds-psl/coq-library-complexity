...
The function's different cases make use of primitive functions introducing the CNF constraints. They can be found in Figure~\ref{fig:prim_cnfs}, together with their correctness statements. 
