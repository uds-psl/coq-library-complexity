...
Cliques can be defined \coqlink[isfKClique]{in the expected way} for the flat graphs. 
The only difference to the definition on non-flat graphs is that we have to explicitly require the graph to be syntactically wellformed (see \text{FlatUGraph\_wf}). 
...
\begin{theorem}[][kSAT_reduces_to_FlatClique]
