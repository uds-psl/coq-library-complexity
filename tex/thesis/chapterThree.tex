...
Cliques can be defined \coqlink[isfKClique]{in the expected way} for the flat graphs. The corresponding problem is called \mnotec[FlatClique]{\FlatClique{}}. A proof that \FlatClique{} is contained in \NP{} is straightforward. \todo{Coq, link}
