...
\end{lemma}
\begin{proof}
  We do case analysis on the number of input symbols $k$ and the number of steps $t$ in order to determine five symbols at the center. Then, Lemma~\ref{lem:rewrite_split} allows us to decompose the rewriting. The different cases make use of the previous lemmas.
\end{proof}
