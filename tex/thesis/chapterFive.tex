...
\begin{lemma}[Empty Tape Half: Adding Symbols]\label{lem:nilstr_add}\leavevmode
  \begin{enumerate}
...
\begin{lemma}[Empty Tape Half: Removing Symbols]\label{lem:nilstr_rem}\leavevmode
  \begin{enumerate}
...
\todo{using one of the proofs here: demonstrate why we use rw windows of size three (instead of 2)}
