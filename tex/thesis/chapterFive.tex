...
As \mnote[FlatPRLang]{\textbf{FlatPR}} the finite types for the alphabet of \PR{} are not directly extractable to L, we define flat versions \textbf{FlatPR} and \textbf{Flat3PR} similar 
\setCoqFilename{Undecidability.L.Complexity.Problems.Cook.FlatTPR}
to the definition of \FlatClique{} in Chapter~\ref{chap:ksat_clique}.\mnote[FlatTPRLang]{\textbf{Flat3PR}}
...
\setCoqFilename{Undecidability.L.Complexity.Problems.Cook.GenNP}
The full reduction produces a \textbf{Flat3PR} instance, where the flat reification of the rewrite windows is used. As the Turing machines use finite types and vectors, which are both not directly extractable, we also have a flat encoding of these together with a flat variant \mnotec[FlatSingleTMGenNP]{\textbf{FlatTMGenNP}} of \gennp{}.
