...
This can be lifted to express that one of the windows of $R$ holds by computing a disjunction over the list of windows. We assume a function $\encodeWindows : \nat \rightarrow \nat \rightarrow \formula$ taking the two start indices for that purpose, without going into more detail.\mnote{\encodeWindows}
