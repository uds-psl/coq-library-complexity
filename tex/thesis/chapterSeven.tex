...
\begin{definition}[Encoding of Predicates][encodesPredicateAt]
  ...
  A formula $f$ encodes a predicate $p$ on a range of variables $I = [\textsf{start}.. + \textsf{len})$ if, for every assignment $a$, $a \models f$ is equivalent to satisfaction of $p$ under the partial assignment given by $I$:
