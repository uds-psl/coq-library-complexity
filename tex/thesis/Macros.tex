...
\newcommand{\con}{\mathbin{+\mkern-10mu+}}
...
\newcommand{\leb}[2]{#1\overset{?}{\le}#2}

\newcommand{\bnfmid}{~\mid~}

\newcommand{\concat}{\con}
\newcommand{\rconcat}{\textsf{concat}}
