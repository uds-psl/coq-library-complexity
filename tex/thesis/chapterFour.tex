...
\newcommand*{\TallestContent}{\ensuremath{\gamma}}% <-- This should be the tallest content
...
\end{center}
Our definition relates to this one in a similar way the verifier characterisation of \NP{} relates to the one using nondeterminism: the nondeterminism is moved into the input. The reason for that is that formally working with nondeterminism is unpleasant.
