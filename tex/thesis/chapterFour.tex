...
The construction presented in the previous section can simulate a deterministic Turing machine given an initial configuration. In the definition of \gennp{}, however, one part of the input, the certificate, is existentially quantified. 
