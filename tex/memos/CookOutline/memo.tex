...
\begin{center}
  ...
  \rewwin{\sigma_1 & q^\blank & \blank}{\polpos{m_1} & p^{\sigma_1} & \polpos{b}} \\[3ex]
  ...
  \rewwin{\sigma_1 & \sigma_2 & q^\blank}{\polpos{m_1} & \polpos{\sigma_1} & p^{\sigma_2}}
   \\[3ex]
  \rewwin{q^\blank & \blank & \blank}{p^{m_1} & \polpos{b} & \blank}
  \rewwin{q^\blank & \sigma_1 & m_1}{p^{m_2} & \polpos{b} & \polpos{\sigma_1}}
\end{center}
...
\begin{center}
  ...
  \\[3ex]
  \rewwin{\blank & \blank & q^\blank}{\blank & \polneg{b} & p^{m_2}}
  \rewwin{m_1 & \sigma_1 & q^\blank}{\polneg{\sigma_1} & \polneg{b} & p^{m_2}}
\end{center}

\paragraph*{$\delta(q, \None) = (p, \Some{b}, \textsf{N})$:}
\begin{center}
  \rewwin{m_1 & q^\blank & \blank}{\polneut{m_1} & p^b & \blank}
  \rewwin{\blank & q^\blank & m_1}{\blank & p^b & \polneut{m_1}} \\[3ex]
  \rewwin{q^{\blank} & \sigma_1 & m_1}{p^b & \polneut{\sigma_1} & \polneut{m_1}} 
  \rewwin{q^\blank & \blank & \blank}{p^b & \blank & \blank} \\[3ex]
  \rewwin{m_1 & \sigma_1 & q^\blank}{\polneut{m_1} & \polneut{\sigma_1} & p^b}
  \rewwin{\blank & \blank & q^{\blank}}{\blank & \blank & p^b}
...
\begin{center}
  ...
  \rewwin{\blank & \blank & q^\blank}{\blank & \blank & p^\blank}
  \rewwin{\blank & \sigma_1 & q^\blank}{\blank & \blank & p^{\sigma_1}}
  \rewwin{\sigma_2 & \sigma_1 & q^\blank}{\polpos{m_1} & \polpos{\sigma_2} & p^{\sigma_1}} \\[3ex]
...
\begin{center}
  \rewwin{m & q^\blank & \blank}{\polneut{m} & p^{\blank} & \blank}
  \rewwin{\blank & q^{\blank} & m} {\blank & p^{\blank} & \polneut{m}} \\[3ex]
  \rewwin{\blank & \blank & q^\blank}{\blank & \blank & p^\blank}
...
\begin{center}
  ...
  \rewwin{m_1 & \sigma_1 & q^{m_2}}{\polneut{m_1} & \polneut{\sigma_1} & q^{m_2}} 
...
\begin{lemma}[Multi-step Simulation]\label{lem:mssim}
  Let $(q, \mathit{tape}) \reprc{} s$ and $(q, \mathit{tape}) \succ^k (q', \mathit{tape}')$ for some $k \ge 0$ and $\length{\mathit{tape}} \le z - k$, $k \le z$. There exists a uniquely determined string $s'$ with $s \strent^k s'$ and $(q', \mathit{tape}') \reprc{} s'$. 
\end{lemma}
\begin{proof}
...
\begin{theorem}[Completeness]\label{thm:simcomplete}
  Let a configuration $(q, \mathit{tape})$ be given with $\length{\mathit{tape}} \le k$. Then there exists a string $s$ with $(q, \mathit{tape}) \reprc{} s$. If $(q, \mathit{tape}) \rhd^{\le t} (q', \mathit{tape}')$, then there exists a string $s'$ with $s \strent{}^t s'$, $(q', \mathit{tape}') \reprc{} s'$ and $s' \models \Rfinal$.
\end{theorem}
\begin{proof}
...
\begin{center}
  ...
  \rewwin{\underline{\#} & \bot & \bot}{\underline{\#} & \blank & \blank}
  \rewwin{\bot & \bot & \underline{\#}}{\blank & \blank & \underline{\#}} \\[3ex]
